...
export default function ForgotPassword() {
    ...
    const [resetLink, setResetLink] = useState(null); // DEV MODE ONLY
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(data.message || 'Reset instructions sent!', { duration: 4000 });

            // In a real app this would go to user's email.
            // For testing/development, we display exactly what to click.
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                border: '1px solid var(--border-default)', // glass effect omitted for brevity
            }}>
                ...
                {resetLink ? (
                    <div style={{ padding: 20, background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.2)', borderRadius: 12, textAlign: 'center' }}>
                        <p style={{ fontSize: '0.85rem', color: 'var(--text-primary)', marginBottom: 12 }}>
                            <strong>DEV MODE:</strong> We intercepted your email link for testing:
                        </p>
                        <a href={resetLink} style={{
                            display: 'inline-block', background: 'var(--accent-primary)', color: '#fff',
                            textDecoration: 'none', padding: '10px 16px', borderRadius: 8, fontSize: '0.85rem', fontWeight: 600
                        }}>

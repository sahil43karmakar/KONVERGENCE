...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success('🎉 Login Successful!', { duration: 3000, style: { background: '#10B981', color: '#fff', fontWeight: 600 } });
        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{ textAlign: 'center', fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: 28 }}>
                    {isRecruiter ? 'Sign in to manage your talent pipeline' : 'Sign in to sync your success'}
                </p>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    <div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                            ...
                            <Link to="/forgot-password" style={{ fontSize: '0.75rem', color: 'var(--accent-primary)', fontWeight: 600, textDecoration: 'none' }}>Forgot?</Link>
                        </div>
                ...
                <p style={{ textAlign: 'center', fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: 24 }}>
                    New to SkillSync?{' '}
                    <Link to={`/register${roleParam}`} style={{ color: 'var(--accent-primary)', textDecoration: 'none', fontWeight: 700 }}>
                        Create Account
                    </Link>
                </p>
            </div>
